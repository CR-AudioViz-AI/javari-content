// app/layout.tsx — Javari Content Studio
// CR AudioViz AI · EIN 39-3646201 · June 2026
import type { Metadata } from "next";
export const metadata: Metadata = {
  title: "Javari Content Studio | CR AudioViz AI",
  description: "AI content creation — books, ebooks, presentations, cover letters, resumes. Professional content at any scale.",
  keywords: "AI book writer, ebook creator, AI resume builder, cover letter generator, CR AudioViz AI, Javari AI, javariai.com",
  ...
  openGraph: {
    ...
    title: "Javari Content Studio | CR AudioViz AI",
    description: "AI content creation — books, ebooks, presentations, cover letters, resumes. Professional content at any scale.",
    url: "https://javari-content.vercel.app",
  ...
  alternates: { canonical: "https://javari-content.vercel.app" },
};
